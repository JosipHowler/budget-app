    ...
    <>
      <Container className="my-4">
        <Stack direction="horizontal" gap="2" className="mb-4">
          ...
          <Button variant="primary" size="lg" onClick={() => setShowAddBudgetModal(true)}>Add Budget</Button>
          <Button variant="outline-primary" size="lg" onClick={openAddExpenseModal}>Add Expense</Button>
        </Stack>
        <div style={{display: "grid", gridTemplateColumns: "repeat(auto-fill, min-max(300px, 1fr))", gap: "1rem", alignItems: "flex-start"}}>
          {budgets.map(budget => {
